...
function Retourner(){
    if(pasOK){
        ...
        document.body.innerHTML += '<form action="index.php" method="POST"><input type="hidden" name="score" value="' + seconde100m +'"/><input type="hidden" name="id_niveau_score" value="' + window.location.search.substring(11) + '"></form>';
